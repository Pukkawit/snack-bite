...
export default function AdminDashboard({
  ...
  console.log("User Information: ", {
    userId: user.id,
    bossId: process.env.NEXT_PUBLIC_DEFAULT_BOSS_SUPABASE_UID,
  ...
  return (
    <div className="container mx-auto w-full flex-1 flex justify-center items-center">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <div
          onClick={() => {
            router.push(`/admin/${tenantSlug}/menu-items-form`);
          }}
        ...
        <div
          onClick={() => {
            router.push(`/admin/${tenantSlug}/restaurant-info-form`);
          }}
        ...
        {superAdmin && (
          <div
            ...
            className="border-border cursor-pointer transition-colors duration-300 hover:bg-rose-400 dark:hover-bg-rose-400 bg-rose-500 dark:rose-300 rounded-md p-6 h-32 w-32 flex items-center justify-center"
          >
            <div className="flex flex-col gap-2 items-center text-center">
              <Settings size={48} />
              <p className="text-sm leading-tight">Settings </p>
            </div>
          </div>
        )}
      </div>
